    ...
    return(
        ...
        <div className="travel">
            ...
            <div className="Blog-container">
                  ...
                  <div className="blog">
                    <div className="image">
                      <img src="/images/relax-1.webp" alt="Blog Cover" />
                    </div>
                    <div className="blog-content">
                      <h1>Top 5 Beaches in Corfu Greece</h1>
                      <p>
                      Corfu the emerald jewel of the Ionian Sea is home to some of Greece is most stunning beaches.
                ...
                {/* {Blog-2} */}
                  <div className="blog">
                    <div className="image">
                      <img src="/images/relax-2.webp" alt="Blog Cover" />
                    </div>
                    <div className="blog-content">
                ...
                {/* {Blog-3} */}
                  <div className="blog">
                    <div className="image">
                      <img src="/images/relax-3.webp" alt="Blog Cover" />
                    </div>
                    <div className="blog-content">
                      <h1>Silky Sands Turquoise Surf</h1>
                      <p>
                      Nothing compares to the allure of silky sands and turquoise surf where nature is beauty meets tranquility.
                      </p>
                    </div>
                    <div className="blog-icons">
                      <div className="icon-left">
