        ...
        <>
            <div className="girl">
                ...
                <div className="girl-blog">
                    ...
                    <p>
                    Paleokastritsa is one of Corfu's most famous beaches, boasting turquoise waters framed by dramatic
                     cliffs and lush greenery. The area offers a mix of sandy and pebble shores, making it a haven for sunbathers 
                    and adventure seekers alike.
                    </p>

                    <h2>Canal d Amour  Sidari</h2>
                    <p>
                    Canal d Amour or the Channel of Love is famous for its distinctive sandstone formations and
                     legendary romantic allure.According to local folklore couples who swim through the canal together will 
                ...
                <div className="recent">
                    ...
                    <div className="girl-parent-card">
                        <div className="girl-card">
                            ...
                            <div className="girl-card">
                            <div className="card-image"><img src="/images/relax-3.webp"></img></div>
                            <Link href="relax-3"><h2>Silky Sands Turquoise Surf</h2></Link>
                            <div className="blog-icons">
                                <div className="icon-left">
                                    <span className="icon-item">
                                        <FaEye /> 150
