        ...
        <>
            <div className="girl">
                ...
                <div className="girl-blog">
                    ...
                    <p>
                    Mexico is culinary heritage is a tapestry woven from ancient traditions local ingredients
                    ...
                    Mexican desserts are as diverse and delicious as the savory dishes. Indulge in churros dipped in
                     chocolate creamy flan or pan dulce sweet bread. During festivals dont miss alegrías a sweet
                      treat made from amaranth and honey, or calaveras de azúcar colorful sugar skulls made for Día de 
                      los Muertos.
                ...
                <div className="recent">
                    ...
                    <div className="girl-parent-card">
                        <div className="girl-card">
                            ...
                            <Link href="eat-3"><h2>East of Eden  The Best of Thailands Markets</h2></Link>
                            <div className="blog-icons">
                                <div className="icon-left">
                                    <span className="icon-item">
                                        <FaEye /> 150
