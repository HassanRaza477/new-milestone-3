        ...
        <>
            <div className="girl">
                ...
                <div className="girl-blog">
                    ...
                    <p>
                    Oaxaca is the land of mole and my taste buds were ready for the adventure. 
                    At a quaint family owned restaurant I tried mole negro, a rich chocolatey
                     and spicy sauce served with tender chicken. The layers of flavors were unlike
                      anything Id ever tasted.
                    </p>

                    <h2>The Markets of Oaxaca</h2>
                    <p>
                    No visit to Oaxaca is complete without a trip to its vibrant markets.
                     At Mercado Benito Juárez I wandered through aisles brimming with fresh produce
                      handmade crafts and aromatic spices. Local artisans displayed their intricate textiles
                ...
                <div className="recent">
                    ...
                    <div className="girl-parent-card">
                        <div className="girl-card">
                            <div className="card-image"><img src="/images/girl.webp"></img></div>
