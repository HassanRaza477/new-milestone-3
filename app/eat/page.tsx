    ...
    return(
        ...
        <div className="travel">
            ...
            <div className="Blog-container">
                  ...
                  <div className="blog">
                    <div className="image">
                      <img src="/images/eat-1.webp" alt="Blog Cover" />
                    </div>
                ...
                {/* {Blog-2} */}
                  <div className="blog">
                    <div className="image">
                      <img src="/images/eat-2.webp" alt="Blog Cover" />
                    </div>
                    <div className="blog-content">
                ...
                {/* {Blog-3} */}
                  <div className="blog">
                    <div className="image">
                      <img src="/images/eat-3.webp" alt="Blog Cover" />
                    </div>
                    <div className="blog-content">
                      <h1>East of Eden The Best of Thailand is Markets</h1>
                      <p>
                      Thailand is markets are a sensory wonderland a vibrant tapestry of sights sounds 
